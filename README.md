...
| **`googlePay`**            | <code>{ email: string; billingAddress: <a href="#postaladdress">PostalAddress</a>; shippingAddress: <a href="#postaladdress">PostalAddress</a>; type?: string; token?: string; lastTwo?: string; network?: string; cardHolderName?: string; threeDSecureCard?: <a href="#threedsecurecard">ThreeDSecureCard</a>; }</code> |
